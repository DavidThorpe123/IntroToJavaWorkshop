...
int backgroundcolor = -1;
		...
		//10. if the mouse is on the end color
				if (mouseColor == -65279)
					JOptionPane.showMessageDialog(null, "You survived death");
...
sound.play();
		//9. drop an image into your day5 package, and use the showScaryImage method to scare your vict
showScaryImage("keem daughter.png");
